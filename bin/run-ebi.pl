...
for my $core_db (@core_dbs) {
  ...
  print `sudo -u wormbase rsync -av $work_dir/${spe}_${cies}/$assembly/  /ebi/ftp/pub/databases/wormbase/parasite/web_data/rnaseq_studies/releases/next/${spe}_${cies}_${bp}/`;
} 
